...
public class DeletePro extends Application{
	...
	public void start(Stage primaryStage){
		...
		Label l2 = new Label("Enter Product ID to Delete");
		...
		b1.setOnAction(new EventHandler<ActionEvent>(){
			public void handle(ActionEvent ae){
				if(t2.getText().equals("")){
					...
					String sql = "DELETE FROM product WHERE productID ='"+t2.getText()+"'";
					da.updateDB(sql);
					//t1.setText("");
					t2.setText("");
					//t3.setText("");
		...
		primaryStage.setTitle("Delete From Inventory");
		primaryStage.setScene(scene);
		primaryStage.show();
		DeletePro.classStage = primaryStage;
		}
